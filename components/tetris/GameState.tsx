...
export default function GameState({ 
  ...
  const statsClass = "py-2 px-4 bg-gray-200 dark:bg-gray-800 rounded mb-2";
    ...
    <div className="flex flex-col items-center w-48">
      ...
      <div className="w-full space-y-3">
        {!isGameOver && !isPaused && (
          <button 
            onClick={onPause} 
            className="w-full py-2 bg-yellow-500 hover:bg-yellow-600 text-white rounded transition-colors"
          >
            Pause
          </button>
        )}
      ...
      {isGameOver && (
        <div className="mt-6 p-3 bg-red-100 dark:bg-red-900 border border-red-300 dark:border-red-700 rounded text-center">
